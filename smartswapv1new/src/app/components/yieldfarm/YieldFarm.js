     ...
     rgba(64, 186, 213, 0.5) 175.99%
      ...
      >
        ...
        <Flex justifyContent="space-between" width="100%">
          ...
          <Box marginTop="15px" align="left">
            {content.img === 'bnb.svg' && <img src={BNBImage} mr="3" />}
            {content.img === 'eth.svg' && <img src={ETHImage} mr="3" />}
            {content.img === 'rgp.svg' && <img src={RGPImage} mr="3" />}
            {content.img === 'busd.svg' && <img src={BUSDImage} mr="3" />} {content.earn}
          </Box>
        </Flex>
        <Flex justifyContent="space-between" width="100%">
          <Box
