      ...
      <Flex mb="10px" py={2} justifyContent="space-between">
        ...
        <Box>
          {value.path[0].token === "RGP" ?
            <img src={RGPImage} /> : value.path[0].token === "BUSD" ?
              <img src={BUSDImage} /> : value.path[0].token === "ETH" ?
                <img src={ETHImage} /> : <img src={BNBImage} />
          }
          {value.pooledToken0}
        </Box>
      </Flex>
      <Flex mb="10px" py={2} justifyContent="space-between">
        ...
        <Box>
          {value.path[1].token === "RGP" ?
            <img src={RGPImage} /> : value.path[1].token === "BUSD" ?
              <img src={BUSDImage} /> : value.path[1].token === "ETH" ?
                <img src={ETHImage} /> : <img src={BNBImage} />
          }
          {value.pooledToken1}
        </Box>
