      ...
      >
        <Box>
          {value.path[0].token === "RGP" ?
            <imag src={RGPImage} /> : value.path[0].token === "BUSD" ?
              <imag src={BUSDImage} /> : value.path[0].token === "ETH" ?
                <imag src={ETHImage} /> : <imag src={BNBImage} />
          }  {value.path[1].token === "RGP" ?
            <imag src={RGPImage} /> : value.path[1].token === "BUSD" ?
              <imag src={BUSDImage} /> : value.path[1].token === "ETH" ?
                <imag src={ETHImage} /> : <imag src={BNBImage} />
          }{' '}
